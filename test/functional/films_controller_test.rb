...
class FilmsControllerTest < ActionController::TestCase
  ...
  test "should create film" do
    assert_difference('Film.count') do
      post :create, film: { date: @film.date, position: @film.position, status: @film.status, title: @film.title }
    end
  ...
  test "should update film" do
    put :update, id: @film, film: { date: @film.date, position: @film.position, status: @film.status, title: @film.title }
    assert_redirected_to film_path(assigns(:film))
  end
